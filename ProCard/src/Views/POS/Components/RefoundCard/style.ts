...
export const BoxContainerRefound = styled.div`
    background: #fff;
...
export const TxtRefound = styled.p`
    color: #444;
    margin-left: 10px;
    font-size: 18px;
`;

export const RefoundBox = styled.div`
    display: flex;
    margin-top: 5px;
`;

export const TxtRefoundSyn = styled.p`
    color: #444;
    font-size: 25px;
`;

export const InpRefound = styled.input`
